...
public sealed class LegalCatalogTests
{
    ...
    public void Manifest_DeclaresClauseAndMatterToolsWithApprovalGatedWrites()
    {
        ...
        Assert.Equal(
            ["search_clauses", "draft_clause", "create_matter", "set_matter_status", "list_matters", "add_matter_party", "check_conflicts", "attest_conflict_check", "list_conflict_attestations", "attach_document_to_matter", "list_matter_documents", "get_playbook", "start_bulk_review", "index_matter_documents", "restrict_matter_access", "open_matter_access", "connect_matter_folder", "sync_matter_folder"],
